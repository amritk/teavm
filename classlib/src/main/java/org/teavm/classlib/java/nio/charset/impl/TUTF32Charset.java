...
public class TUTF32Charset extends TCharset {
    private final boolean littleEndian;

    public TUTF32Charset(String canonicalName, boolean littleEndian) {
    ...
    public TCharsetDecoder newDecoder() {
        return new TUTF32Decoder(this, littleEndian);
    }

    @Override
    public TCharsetEncoder newEncoder() {
        return new TUTF32Encoder(this, littleEndian);
    }
}
